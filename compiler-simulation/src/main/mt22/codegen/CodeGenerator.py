...
class CodeGenerator:
    ...
    def init(self):
        return [Symbol("readInteger", FunctionPrototype(list(), IntegerType()), CName(self.libName)), Symbol("printInteger", FunctionPrototype([IntegerType()],VoidType()), CName(self.libName))]
...
class CodeGenVisitor(BaseVisitor):
    ...
    def visitClassDecl(self, ast, c):
        ...
        [self.visit(ele, SubBody(None, self.env))
         for ele in ast.memlist if type(ele) == FuncDecl]
        # generate default constructor
        self.genMETHOD(FuncDecl(Id("<init>"), list(), None, BlockStmt([], [])), c, Frame("<init>", VoidType()))
    ...
    def genMETHOD(self, consdecl, o, frame):
        ...
        mtype = FunctionPrototype(intype, returnType)
    ...
    def visitFuncDecl(self, ast, o):
        ...
        return Symbol(ast.name, FunctionPrototype([x.typ for x in ast.param], ast.returnType), CName(self.className))
